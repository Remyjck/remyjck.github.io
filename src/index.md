...
My current main project is to give mechanised formal semantics for <img src="/img/ocaml-logo.svg" alt="Ocaml logo" style="height: 1.5ex"> OCaml, and to provide a program logic for these semantics using [Iris](https://iris-project).
